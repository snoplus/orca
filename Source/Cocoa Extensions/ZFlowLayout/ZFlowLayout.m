...
- (id)initWithFrame:(NSRect)frameRect
{
    if ((self = [super initWithFrame:frameRect]) != nil) {
        ...
        _sizing = ZMakeFlowLayoutSizing( NSMakeSize( 200, 200 ), 10, 0, NO );
...
- (void) addSubview:(NSView *)aView
{
    ...
    _numElements++;
    [self forceLayout];
    [self performSelector:@selector(layoutAndDisplay) withObject:nil afterDelay:0];
}
