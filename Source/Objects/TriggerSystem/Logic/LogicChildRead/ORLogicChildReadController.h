...
@interface ORLogicChildReadController : OrcaObjectController {
    IBOutlet NSTextField* logicChildReadTextField;
    IBOutlet NSStepper*   logicChildReadStepper;
 }
