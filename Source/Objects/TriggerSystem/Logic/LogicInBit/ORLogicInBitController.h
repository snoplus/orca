...
@interface ORLogicInBitController : OrcaObjectController {
    IBOutlet NSTextField* logicInBitTextField;
    IBOutlet NSStepper*   logicInBitStepper;
 }
