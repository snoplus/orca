...
#import "ORLogicScalerShipModel.h"
#import "ORTriggerLogic.h"

@implementation ORLogicScalerShipModel
...
- (void) setUpImage
{
	...
	[n drawAtPoint:NSMakePoint(30,4)];
	[n release];
	[i unlockFocus];		
	[self setImage:i];
	[i release];
