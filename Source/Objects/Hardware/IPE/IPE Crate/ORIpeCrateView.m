...
#import "ORIpeCrateView.h"


#define kNumIpeCrateSlots 21

@implementation ORIpeCrateView

- (int) maxNumberOfCards
{
    return kNumIpeCrateSlots;
}
...
{
	if( [aCard isKindOfClass:NSClassFromString(@"ORIpeControllerCard")]){
...
- (BOOL) canAddObject:(id)obj atPoint:(NSPoint)aPoint
{
	if([super canAddObject:obj atPoint:aPoint]){
		...
		if( [obj isKindOfClass:NSClassFromString(@"ORIpeFireWireCard")]){
			if(aSlot != 0){
