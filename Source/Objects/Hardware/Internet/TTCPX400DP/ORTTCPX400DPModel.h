...
@interface ORTTCPX400DPModel : OrcaObject<ORTcpIpProtocol> {
    ...
    //ORTTCPX_DEFINE_WRITE_VAR(QueryClearLSR, float)
    ...
    //ORTTCPX_DEFINE_WRITE_VAR(QueryAndClearEER, float)
    //ORTTCPX_DEFINE_WRITE_VAR(SetESE, float)
    //ORTTCPX_DEFINE_WRITE_VAR(GetESE, float)
    //ORTTCPX_DEFINE_WRITE_VAR(GetESR, float)
    ...
    //ORTTCPX_DEFINE_WRITE_VAR(QueryAndClearQER, float)
...
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(SetAllOutput, float)
...
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(QueryClearLSR, float)
...
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(QueryAndClearEER, float)
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(SetESE, float)
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(GetESE, float)
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(GetESR, float)
...
//ORTTCPX_DEFINE_WRITE_FUNCTIONS(QueryAndClearQER, float)
...
//ORTTCPX_NOTIFY_WRITE_DEFINE(QueryClearLSR)
...
//ORTTCPX_NOTIFY_WRITE_DEFINE(QueryAndClearEER)
//ORTTCPX_NOTIFY_WRITE_DEFINE(SetESE)
//ORTTCPX_NOTIFY_WRITE_DEFINE(GetESE)
//ORTTCPX_NOTIFY_WRITE_DEFINE(GetESR)
...
//ORTTCPX_NOTIFY_WRITE_DEFINE(QueryAndClearQER)
