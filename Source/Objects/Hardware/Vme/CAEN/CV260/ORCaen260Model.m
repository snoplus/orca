...
static RegisterNamesStruct reg[kNumberOfV260Registers] = {
	{@"Version",			0,0,0, 0xFE, kReadOnly,	kD32}, 
	{@"Modual Type",		0,0,0, 0xFC, kReadOnly,	kD32},
	{@"Fixed Code",			0,0,0, 0xFA, kReadOnly,	kD32}, 
	{@"Interrupt Jumpers",	0,0,0, 0x58, kReadOnly,	kD32},
	{@"Scaler Increase",	0,0,0, 0x56, kReadWrite,kD32},
	{@"Inhibite Reset",		0,0,0, 0x54, kReadWrite,kD32},
	{@"Inhibite Set",		0,0,0, 0x52, kReadWrite,kD32},
	{@"Clear",				0,0,0, 0x50, kReadWrite,kD32},
	...
	{@"Clear VME Interrupt",0,0,0, 0x0C, kReadWrite,		kD32},
	{@"Disable VME Interrupt",	0,0,0, 0xA, kReadWrite,		kD32},
	{@"Enable VME Interrupt",	0,0,0, 0x08, kReadWrite,	kD32},
	{@"Interrupt Level",		0,0,0, 0x06, kWriteOnly,	kD32},
	{@"Interrupt Vector",		0,0,0, 0x04, kReadOnly,		kD32},
};
