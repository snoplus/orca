...
#import "ORSIS3305GenericModel.h"
...
ORSIS3305_IMPLEMENT_NOTIFY(FirmwareVersion);

ORSIS3305_IMPLEMENT_NOTIFY(PreTriggerDelay);

ORSIS3305_IMPLEMENT_NOTIFY(SampleLength);
ORSIS3305_IMPLEMENT_NOTIFY(DacOffset);

ORSIS3305_IMPLEMENT_NOTIFY(ClockSource);
ORSIS3305_IMPLEMENT_NOTIFY(TriggerOutEnabled);
ORSIS3305_IMPLEMENT_NOTIFY(Threshold);
ORSIS3305_IMPLEMENT_NOTIFY(Gt);
ORSIS3305_IMPLEMENT_NOTIFY(TrapFilterTrigger);

ORSIS3305_IMPLEMENT_NOTIFY(SettingsLock);
ORSIS3305_IMPLEMENT_NOTIFY(RateGroup);
ORSIS3305_IMPLEMENT_NOTIFY(SampleDone);
ORSIS3305_IMPLEMENT_NOTIFY(ID);

ORSIS3305_IMPLEMENT_NOTIFY(PulseLength);
ORSIS3305_IMPLEMENT_NOTIFY(SumG);
ORSIS3305_IMPLEMENT_NOTIFY(PeakingTime);
ORSIS3305_IMPLEMENT_NOTIFY(InternalTriggerDelay);

ORSIS3305_IMPLEMENT_NOTIFY(Averaging);
ORSIS3305_IMPLEMENT_NOTIFY(StopAtEvent);
ORSIS3305_IMPLEMENT_NOTIFY(EnablePageWrap);
ORSIS3305_IMPLEMENT_NOTIFY(PageWrapSize);
ORSIS3305_IMPLEMENT_NOTIFY(TestDataEnable);
ORSIS3305_IMPLEMENT_NOTIFY(TestDataType);

ORSIS3305_IMPLEMENT_NOTIFY(StartDelay);
ORSIS3305_IMPLEMENT_NOTIFY(StopDelay);
ORSIS3305_IMPLEMENT_NOTIFY(MaxEvents);
ORSIS3305_IMPLEMENT_NOTIFY(LemoTimestamp);
ORSIS3305_IMPLEMENT_NOTIFY(LemoStartStop);
ORSIS3305_IMPLEMENT_NOTIFY(InternalTrigStart);
ORSIS3305_IMPLEMENT_NOTIFY(InternalTrigStop);
ORSIS3305_IMPLEMENT_NOTIFY(MultiEventMode);
ORSIS3305_IMPLEMENT_NOTIFY(AutostartMode);

ORSIS3305_IMPLEMENT_NOTIFY(CardInited);

@interface ORSIS3305GenericModel (private)
...
@implementation ORSIS3305GenericModel
...
#define kNumSIS3305GenReadRegs 70

static SIS3305GammaRegisterInformation register_information[kNumSIS3305GenReadRegs] = {
...
{
    [self linkToController:@"ORSIS3305GenericController"];
}
...
- (void) setFirmwareVersion:(float)aFirmwareVersion
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericFirmwareVersionChanged object:self];
}
...
- (void) setClockSource:(int)aClockSource
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericClockSourceChanged object:self];
}
...
- (void) setWaveFormRateGroup:(ORRateGroup*)newRateGroup
{
    ...
    [[NSNotificationCenter defaultCenter]
	 postNotificationName:ORSIS3305GenericRateGroupChanged
	 object:self];    
}
...
{ 
	...
	gtMask = aMask;
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericGtChanged object:self];
}
...
{
    if (chan > kNumSIS3305Channels) return NO;
...
- (void) setUseTrapTriggerMask:(short)aMask
{
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericTrapFilterTriggerChanged object:self];
...
{ 
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericThresholdChanged object:self];
	//ORAdcInfoProviding protocol requirement
...
- (void) setDacOffset:(short)aChan withValue:(int)aValue 
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericDacOffsetChanged object:self];
}
...
{ 
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericPulseLengthChanged object:self];
}
...
{ 
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericSumGChanged object:self];
}
...
{ 
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericPeakingTimeChanged object:self];
}
...
- (void) setPreTriggerDelay:(short)aGroup withValue:(int)aPreTriggerDelay
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericPreTriggerDelayChanged object:self];
}
...
- (void) setSampleLength:(short)group withValue:(int)aValue
{
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericSampleLengthChanged object:self];
}
...
- (void) setAveragingType:(short)group withValue:(EORSIS3305GenericAveraging)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericAveragingChanged object:self];
}
...
{ 
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericStopAtEventChanged object:self];
}
...
{ 
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericEnablePageWrapChanged object:self];
}
...
- (void) setPageWrapSize:(short)group withValue:(EORSIS3305PageSize)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericPageWrapSizeChanged object:self];
}
...
{ 
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericTestDataEnableChanged object:self];
}
...
- (void) setTestDataType:(short)group withValue:(EORSIS3305TestDataType)aValue
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericTestDataTypeChanged object:self];
}
...
- (void) setStartDelay:(int)aValue
{
    ...
    startDelay = aValue;
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericStartDelayChanged object:self];
}
- (void) setStopDelay:(int)aValue
{
    [[[self undoManager] prepareWithInvocationTarget:self] setStopDelay:[self stopDelay]];
    stopDelay = aValue;
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericStopDelayChanged object:self];
}
...
- (void) setMaxEvents:(int)aValue
{
    ...
    maxEvents = aValue;
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericMaxEventsChanged object:self];
}
...
- (void) setLemoTimestampEnabled:(BOOL)aVal
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericLemoTimestampChanged object:self];
}
...
- (void) setLemoStartStopEnabled:(BOOL)aVal    
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericLemoStartStopChanged object:self];
}
...
- (void) setInternalTrigStartEnabled:(BOOL)aVal
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericInternalTrigStartChanged object:self];
}
...
- (void) setInternalTrigStopEnabled:(BOOL)aVal    
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericInternalTrigStopChanged object:self];
}
...
- (void) setMultiEventModeEnabled:(BOOL)aVal
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericMultiEventModeChanged object:self];
}
...
- (void) setAutostartModeEnabled:(BOOL)aVal    
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericAutostartModeChanged object:self];
}

	
#pragma mark •••Reg Declarations

- (unsigned long) getPreTriggerDelayOffset:(int) aGroup 
{
    switch (aGroup) {
        case 0: return kSIS3305GenericPreTriggerDelayAdc12;
        case 1: return kSIS3305GenericPreTriggerDelayAdc34;
        case 2: return kSIS3305GenericPreTriggerDelayAdc56;
        case 3: return kSIS3305GenericPreTriggerDelayAdc78;
    }
...
{
    switch (channel) {
		case 0: return 	kSIS3305GenericEventDirectoryAdc1;
		case 1: return 	kSIS3305GenericEventDirectoryAdc2;
		case 2: return 	kSIS3305GenericEventDirectoryAdc3;
		case 3: return 	kSIS3305GenericEventDirectoryAdc4;
		case 4: return 	kSIS3305GenericEventDirectoryAdc5;
		case 5: return 	kSIS3305GenericEventDirectoryAdc6;
		case 6: return 	kSIS3305GenericEventDirectoryAdc7;
		case 7: return 	kSIS3305GenericEventDirectoryAdc8;
    }
    return (unsigned long) -1;
}
...
{
	switch (group) {
		case 0: return kSIS3305GenericSampleLengthAdc12;
		case 1: return kSIS3305GenericSampleLengthAdc34;
		case 2: return kSIS3305GenericSampleLengthAdc56;
		case 3: return kSIS3305GenericSampleLengthAdc78;
	}
	return (unsigned long) -1;	 
}
...
{
	switch (group) {
		case 0: return kSIS3305GenericSampleStartAdc12;
		case 1: return kSIS3305GenericSampleStartAdc34;
		case 2: return kSIS3305GenericSampleStartAdc56;
		case 3: return kSIS3305GenericSampleStartAdc78;
	}
	return (unsigned long) -1;	 
}
...
{
	switch (group) {
		case 0: return kSIS3305GenericAdcInputModeAdc12;
		case 1: return kSIS3305GenericAdcInputModeAdc34;
		case 2: return kSIS3305GenericAdcInputModeAdc56;
		case 3: return kSIS3305GenericAdcInputModeAdc78;
	}
	return (unsigned long) -1;	 
}
...
{	
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericIDChanged object:self];
}
...
- (void) clearTimeStamp
{
	...
	[[self adapter] writeLongBlock:&aValue
                         atAddress:[self baseAddress] + kSIS3305GenericKeyTimestampClear
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];
}
...
- (void) forceTrigger
{
    unsigned long aValue = 0;
	[[self adapter] writeLongBlock:&aValue
                         atAddress:[self baseAddress] + kSIS3305GenericKeyArmSampleLogic
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];
	[[self adapter] writeLongBlock:&aValue
                         atAddress:[self baseAddress] + kSIS3305GenericKeySampling
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];    
}
...
- (void) regDump
{
	@try {
		...
		int i;
		for(i=0;i<kNumSIS3305GenReadRegs;i++){
...
- (void) briefReport
{
	...
	[[self adapter] readLongBlock:&EventConfig
						atAddress:[self baseAddress] +kSIS3305EventConfigAdc12
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
	...
	[[self adapter] readLongBlock:&pretrigger
						atAddress:[self baseAddress] + kSIS3305GenericPreTriggerDelayAdc12
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
	...
	[[self adapter] readLongBlock:&sampleLength1
						atAddress:[self baseAddress] + kSIS3305GenericSampleLengthAdc12
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
	...
	[[self adapter] readLongBlock:&sampleStart
						atAddress:[self baseAddress] + kSIS3305GenericSampleStartAdc12
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
	...
	[[self adapter] readLongBlock:&prevNextSampleAddress1
						atAddress:[self baseAddress] + kSIS3305ActualSampleAddressAdc1
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
	...
	[[self adapter] readLongBlock:&prevNextSampleAddress2
						atAddress:[self baseAddress] + kSIS3305ActualSampleAddressAdc2
						numToRead:1
					   withAddMod:[self addressModifier]
					usingAddSpace:0x01];	
...
{  
	...
	[[NSNotificationCenter defaultCenter] postNotificationName:ORSIS3305GenericCardInitedChanged object:self];
...
- (NSDictionary*) dataRecordDescription
{
    ...
    aDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
				   @"ORSIS3305GenericDecoderForWaveform",				@"decoder",
...
- (NSArray*) wizardSelections
{
    ...
    [a addObject:[ORHWWizSelection itemAtLevel:kObjectLevel name:@"Card" className:@"ORSIS3305GenericModel"]];
    [a addObject:[ORHWWizSelection itemAtLevel:kChannelLevel name:@"Channel" className:@"ORSIS3305GenericModel"]];
    return a;
}
...
- (void) runTaskStarted:(ORDataPacket*)aDataPacket userInfo:(id)userInfo
{
    ...
    [aDataPacket addDataDescriptionItem:[self dataRecordDescription] forKey:@"ORSIS3305Generic"];    
...
- (void) takeData:(ORDataPacket*)aDataPacket userInfo:(id)userInfo
{
    ...
    const unsigned maxSubWaveformLength = kMaxSIS3305SingleMaxRecord - 4;
    @try {
        unsigned long check;
...
- (void) resetSamplingLogic
{
    ...
    [self writeAcquisitionRegister:YES];
 	...
 	unsigned long aValue = 0; //value doesn't matter 
	[[self adapter] writeLongBlock:&aValue
                         atAddress:[self baseAddress] + kSIS3305KeyDisarm
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];
...
@implementation ORSIS3305GenericModel (private)
- (NSMutableArray*) arrayOfLength:(int)len
{
	int i;
...
- (void) setUpArrays
{
	...
	if(!averagingSettings)		averagingSettings		= [[self arrayOfLength:kNumSIS3305Groups] retain];
	if(!pageWrapSize)		pageWrapSize		= [[self arrayOfLength:kNumSIS3305Groups] retain];
	if(!testDataType)		testDataType		= [[self arrayOfLength:kNumSIS3305Groups] retain];
...
- (void) writeDelaysAndMaxEvents
{
	...
	[[self adapter] writeLongBlock:&aMask
                         atAddress:[self baseAddress] + kSIS3305GenericStartDelay
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];    
	...
	[[self adapter] writeLongBlock:&aMask
                         atAddress:[self baseAddress] + kSIS3305GenericStopDelay
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];        
    aMask = [self maxEvents] & 0xFFFFF;
	[[self adapter] writeLongBlock:&aMask
                         atAddress:[self baseAddress] + kSIS3305GenericMaximumNumberOfEvents
                        numToWrite:1
                        withAddMod:[self addressModifier]
                     usingAddSpace:0x01];   
}
