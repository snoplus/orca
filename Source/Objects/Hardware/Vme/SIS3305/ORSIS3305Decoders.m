...
- (unsigned long) decodeData:(void*)someData fromDecoder:(ORDecoder*)aDecoder intoDataSet:(ORDataSet*)aDataSet
{
	...
	if(lastWord == 0xdeadbeef){
        ...
        if(getRatesFromDecodeStage && !skipRateCounts){
			...
			if(!obj){
				NSArray* listOfCards = [[[NSApp delegate] document] collectObjectsOfClass:NSClassFromString(@"ORSIS3305Model")];
...
@implementation ORSIS3305DecoderForMca
...
- (unsigned long) decodeData:(void*)someData fromDecoder:(ORDecoder*)aDecoder intoDataSet:(ORDataSet*)aDataSet
{
	...
	[aDataSet loadSpectrum:[NSMutableData dataWithBytes:&ptr[2] length:(length-2)*sizeof(long)] 
					sender:self  
				  withKeys:@"SIS3305",@"MCA",crateKey,cardKey,channelKey,nil];
...
@implementation ORSIS3305McaDecoder
