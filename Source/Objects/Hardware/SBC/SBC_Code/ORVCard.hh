...
class ORVCard 
{
   public:
       ORVCard(SBC_card_info* ci)  
         {  memcpy(&fCardInfo, ci, sizeof(fCardInfo)); }
       virtual ~ORVCard() {} 
