...
@property (nonatomic,retain) NSColor* goodColor;
@property (nonatomic,retain) NSColor* badColor;
...
#define kManualOnly	  0
#define k2BitReadBack 1
#define kControlOnly  2
