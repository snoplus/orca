...
@interface ORGateKeyController : ORGateElementController 
{
    IBOutlet NSTextField* lowValueField;
    IBOutlet NSTextField* highValueField;
    IBOutlet NSMatrix* acceptenceMatrix;
}
